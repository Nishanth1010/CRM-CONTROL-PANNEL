...
export async function POST(req: NextRequest) {
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'Resend OTP - XY-CRM',
      html: `
        <div style="font-family: 'Georgia', serif; color: #333; padding: 20px; line-height: 1.6;">
          <h2 style="color: #0066cc; margin-bottom: 20px; font-weight: normal; font-size: 18px;">XY-CRM</h2>
          <p style="font-size: 14px; margin-bottom: 15px;">Dear Admin,</p>
          ...
          <p style="font-size: 14px; margin-top: 15px;">Best Regards,<br style="font-size: 12px; margin-top: 15px;">Team XY-CRM</p>
        </div>
      `,
    };
